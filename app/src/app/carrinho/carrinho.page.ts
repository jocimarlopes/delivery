...
export class CarrinhoPage implements OnInit {
  ...
  constructor(public helpers: HelpersService, public userService: UserService, public alertController: AlertController, private storage: NativeStorage, private actRouter: ActivatedRoute, private router: Router, private provider:Post, public toast: ToastController) {
   }
